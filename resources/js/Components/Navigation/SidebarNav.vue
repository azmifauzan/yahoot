...
const icons = {
    ...
    tag: 'M7 7h.01M7 3h5.586a1 1 0 01.707.293l7.414 7.414a1 1 0 010 1.414l-7.586 7.586a1 1 0 01-1.414 0L4.293 12.293A1 1 0 014 11.586V6a3 3 0 013-3z',
    ...
    trophy: 'M5 3h14M5 3v4a7 7 0 007 7 7 7 0 007-7V3M5 3H3v2a4 4 0 004 4m12-6h2v2a4 4 0 01-4 4m-5 5v4m-4 0h8',
};
</script>
