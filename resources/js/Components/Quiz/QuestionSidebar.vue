...
const emit = defineEmits(['select', 'add', 'reorder', 'delete', 'ai-generate']);
    ...
    <div class="w-full md:w-64 flex-shrink-0 overflow-y-auto border-r border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-950">
        ...
        <div class="sticky top-0 z-10 border-b border-gray-100 bg-white p-3 dark:border-gray-800 dark:bg-gray-950">
            ...
            <button
                ...
                class="mt-2 flex w-full items-center justify-center gap-2 rounded-lg border border-primary-200 px-3 py-2 text-sm font-semibold text-primary-600 transition hover:bg-primary-50 dark:border-primary-800 dark:text-primary-400 dark:hover:bg-primary-900/30"
            >
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
