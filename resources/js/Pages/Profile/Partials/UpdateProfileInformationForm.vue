        ...
        <template #form>
                ...
                <div v-if="$page.props.jetstream.hasEmailVerification && user.email_verified_at === null">
                    <p class="text-sm mt-2">
                        ...
                        <Link
                            ...
                            method="post"
                            as="button"
                            class="underline text-sm text-gray-600 hover:text-primary-600 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <select
                    id="locale"
                    v-model="form.locale"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-primary-400 dark:focus:ring-primary-400"
                >
